...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Start()
    {
        KitchenGameManager.Instance.OnLocalGameUnpaused += KitchenGameMnager_OnGameUnpaused;
        UpdateVisual();
        Hide();
        HidePressToRebindKey();
    }

    private void KitchenGameMnager_OnGameUnpaused(object sender, System.EventArgs e)
    {
        Hide();
    }
    ...
    private void UpdateVisual()
    {
        ...
        musicText.text = "Music - " + Mathf.Round(MusicManager.Instance.GetVolume() * 100f) + "%";
