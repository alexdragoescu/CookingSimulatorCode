...
public class LobbyUI : MonoBehaviour
{
    ...
    [SerializeField] private TMP_InputField joinedCodeInputField;
    ...
    private void Awake()
    {
        ...
        joinCodeButton.onClick.AddListener(() => { KitchenGameLobby.Instance.JoinWithCode(joinedCodeInputField.text); });
